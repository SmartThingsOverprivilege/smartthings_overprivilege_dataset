...
definition(
    ...
    author: "SmartThings",
    description: "Get a push notification when a SmartSense Presence tag or smartphone arrives at a location.",
...
preferences {
    ...
    section("") {
        input "doorControl", "capability.doorControl", multiple: true
    }
}
